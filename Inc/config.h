...
#define CTRL_MOD_REQ    VLT_MODE        // [2] Control mode request: OPEN_MODE, VLT_MODE (default), SPD_MODE, TRQ_MODE. Note: SPD_MODE and TRQ_MODE are only available for CTRL_FOC!
#define DIAG_ENA        0               // [0] Motor Diagnostics enable flag: 0 = Disabled, 1 = Enabled (default)
